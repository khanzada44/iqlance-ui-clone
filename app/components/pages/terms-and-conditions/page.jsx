...
export default function TermsAndConditions() {
  ...
  return (
    <main className="min-h-screen text-slate-800">
      ...
      <section>
        <div className="mx-auto mt-10 mb-10  max-w-8xl">
          <div className="space-y-8 rounded-2xl  p-6 shadow-sm sm:p-10 lg:p-12">
      ...
      <div className="relative z-10  bg-black text-center">
        ...
        <div className="py-8">
          ...
          <h2 className="mb-6 text-4xl font-bold text-white sm:text-5xl md:text-6xl together">
            Let&apos;s work together!
          </h2>
