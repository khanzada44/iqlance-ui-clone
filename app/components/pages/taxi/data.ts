...
export const sliderData = [
  ...
  {
    id: 3,
    icon: "/images/AI-based-Mobile-App-Development.svg",
    title: "  Artificial Intelligence ",
    description:
      "Using ML algorithms with Python and continuously learn from ride history, smarter driver-passenger matching retention.",
  },
  
  {
    id: 4,
    icon: "/images/End-to-end-Support.png",
    title: " Virtual Assistants ",
    description:
      "Scalable cloud architecture leveraging AWS and Kubernetes ensures high availability, automated scaling, and low latency operations for enterprise applications.",
  },
];
export const portfolioSlides = [
  {
    heading: "",
    title: "Ride Sharing Software",
    description:
      "Our Ride Sharing Software revolutionizes transportation by offering a seamless connection between drivers and kids, catering specifically to parents seeking safe transportation for their children to and from school.",
...

  {
    ...
    image:
      "/images/image_2024_09_24T09_54_49_610Z.png",
  },
  {
    heading: "",
    title: "Ride Sharing App",
    description:
      "Ride Sharing App is a Canadian service dedicated to helping parents manage their children’s transportation needs with safety at its core.",
    ...
    image:
      "/images/image_2024_09_24T09_55_51_379Z.png",
  },
