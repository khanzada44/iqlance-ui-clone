...
export const footerColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Asp.net Development', href: '/services/asp-net-development' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Hire iPhone Developers', href: '/hire-iphone-developers' },
      { label: 'Hire Mobile Developers', href: '/hire-mobile-developers' },
      { label: 'Hire Software Developers', href: '/hire-software-developers' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Wellness & Fitness", href: "/industry/wellness-and-fitness" },
      { label: "Real estate", href: "/industry/real-estate" },
      { label: "Food & Restaurant", href: "/industry/food-ordering" },
      { label: "E-commerce", href: "/industry/ecommerce" },
      { label: "Education", href: "/industry/elearning-app" },
    ],
  },
  {
    id: 'solution',
    ...
    links: [
      ...
      { label: "Taxi Booking", href: "/solutions/taxi" },
      { label: "Restaurant", href: "/solutions/restaurant" },
      { label: "Fitness", href: "/solutions/fitness"},
      { label: "Social Networking", href: "/solutions/social-media" },
      { label: "Dating App", href: "/solutions/dating"},
      { label: "Food Delivery App", href: "/solutions/food-delivery-app"},
    ],
  },
];
